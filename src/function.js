...
export const stokları500kgUzerinde = (fishFarm) => {
  return fishFarm.filter((fish) => fish.stockVolumeInKg > 500);
};

//2) 9 Fr arasında fiyat aralığına sahip balıklar nelerdir? ve 12 Fr?
export const frankaraligi9ve12 = (fishFarm) => {
  return fishFarm.filter((fish) => fish.price >= 9 && fish.price < 12);
};
...
const romndykisSonbaharbalikOrtalama = () => {};
const findTheAveragePriceOfFishSoldInTheRomandyForTheWinterAndFallSeason = (
  pArray
) => {
